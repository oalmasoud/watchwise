        ...
        <div className='container mx-auto px-3 my-10'>
            ...
            <div className='relative'>
                ...
                <div className='absolute top-0 hidden lg:flex justify-between w-full h-full items-center'>
                    <button onClick={handlePrev} className='bg-white p-1 text-black rounded-full -ml-2 z-10 cursor-pointer'>
                        <FaAngleLeft/>
                    </button>
                    <button onClick={handleNext} className='bg-white p-1 text-black rounded-full -mr-2 z-10 cursor-pointer'>
                        <FaAngleRight/>
                    </button>
                </div>
            </div>
